...
- **Tests:** `Assets/Scripts/Tests/EditMode/` — 64 tests, all green (2026-08-03): CombatMathTests 9, RngStreamTests 7, BlockMathTests 4, CombatEngineTests 14, StatusHookTests 15, CardMechanicsTests 10, EnemyAiTests 5 (incl. full-battle replay snapshot). Shared fixtures live in `TestContent.cs`. **Pattern: every pure-logic module gets NUnit tests in STS.Core.Tests.**
